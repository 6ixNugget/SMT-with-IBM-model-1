...
if __name__ == "__main__":
    LM_f = lm_train("./data/Hansard/Testing", "f", "french")
    LM_e = lm_train("./data/Hansard/Testing", "e", "english")
    for i in range(5):
        delta = i * 0.2
        print("English model, delta = "+ str(delta) + " perplexity = " + str(preplexity(LM_e, "./data/Hansard/Testing/", "e", True, delta)))
        print("French model, delta = "+ str(delta) + " perplexity = " + str(preplexity(LM_f, "./data/Hansard/Testing/", "f", True, delta)))
